...
| **IQ Series** | IQ1_S, IQ2_S, IQ3_S, IQ4_S, IQ5_S | Importance-aware quantization with superior quality retention |
...
Download the latest release from the [GitHub Releases page](https://github.com/LGxNDaRY-GeekedOutAi/The-Geeked-Out-Quantizer-2.0/releases).
...
Download the appropriate installer for your platform from the [Releases page](https://github.com/LGxNDaRY-GeekedOutAi/The-Geeked-Out-Quantizer-2.0/releases).
...
- **Target**: Q4_K_M (4-bit Krause variant M)
- 
- **Balance**: Excellent quality/speed ratio
- 
- **VRAM Usage**: ~2GB per layer
- 
- **Best For**: General-purpose LLM usage, chatbots, agents
- 
...
- `run.ps1` - Main CLI launcher with argument parsing
- 
- `quantize-all.ps1` - Batch processing pipeline
- 
- `install.ps1` - Environment validation and setup utility
- 
...
- 
- GGUF format by [Georgi Gerganov](https://github.com/ggerganov)
- 
- IMatrix research by the LLM optimization community
- 
...
- **GitHub**: [@LGxNDaRY-GeekedOutAi](https://github.com/LGxNDaRY-GeekedOutAi)
- 
- **Issues**: [Report bugs](https://github.com/LGxNDaRY-GeekedOutAi/The-Geeked-Out-Quantizer-2.0/issues)
- 
- **Discussions**: [Feature requests](https://github.com/LGxNDaRY-GeekedOutAi/The-Geeked-Out-Quantizer-2.0/discussions)
- 
...
- **URL**: https://github.com/LGxNDaRY-GeekedOutAi/The-Geeked-Out-Quantizer-2.0
- 
- **Owner**: LGxNDaRY-GeekedOutAi
- 
- **Default Branch**: main
- 


**All files from A:\Geeked.Out have been successfully migrated to this repository.**
